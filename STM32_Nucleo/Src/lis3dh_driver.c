...
#define LIS3DH_CS_LOW()       HAL_GPIO_WritePin(LIS_SPI_CS_Port, LIS_SPI_CS_Pin, GPIO_PIN_RESET)
#define LIS3DH_CS_HIGH()      HAL_GPIO_WritePin(LIS_SPI_CS_Port, LIS_SPI_CS_Pin, GPIO_PIN_SET)
...
//  GPIO_InitStructure.Pin = LIS_SPI_MISO_Pin | LIS_SPI_M0SI_Pin | LIS_SPI_SCK_Pin;
//  GPIO_InitStructure.Mode = GPIO_MODE_AF_PP;
//  GPIO_InitStructure.Alternate = LIS_SPI_AF;
//  GPIO_InitStructure.Pull = GPIO_PULLUP;
//  GPIO_InitStructure.Speed = GPIO_SPEED_HIGH;
//  HAL_GPIO_Init(LIS_SPI_Port, &GPIO_InitStructure);
//    
...
//  GPIO_InitStructure.Pin = LIS_SPI_CS_Pin;
//  GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP;
//  HAL_GPIO_Init(LIS_SPI_CS_Port, &GPIO_InitStructure);
//  
...
//  /* Send and receive Half Word through the SPI1 peripheral */
//  HAL_SPI_TransmitReceive(&SpiHandle, &byte, &rx_buff, 1, 1000);
    
  return (unsigned char)rx_buff;
}
